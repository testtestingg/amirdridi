...
const features = [
  {
    ...
    description: "Modern, responsive websites that look stunning on all devices and deliver results.",
    visual: "deploy",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    description: "Tailored digital solutions including e-commerce and business tools tailored to your needs.",
    visual: "collab",
  },
  {
    number: "04",
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Our Services.
            <br />
            <span className="text-muted-foreground">Solutions built for growth.</span>
          </h2>
        </div>
