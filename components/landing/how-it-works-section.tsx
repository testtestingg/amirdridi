...
const steps = [
  {
    ...
    description: "We collaborate with you to understand your goals, target audience, and unique requirements.",
    code: `// Step 1: Discovery
const project = {
  goals: ['clarify requirements'],
  ...
  },
  {
    ...
    description: "Our experts design and build your solution with modern technologies and best practices.",
    code: `// Step 2: Build
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Three steps.
            <br />
            <span className="text-background/50">From concept to launch.</span>
          </h2>
        </div>
